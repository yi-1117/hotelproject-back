...
@Entity
@Table(name = "epassword_reset")
@Data
public class EPasswordResetBean {
    @Id
    ...
    @JoinColumn(name = "employee_id", referencedColumnName = "employee_id") // 用於與 EmployeeBean 關聯
    private EmployeeBean employee; // 會員，與 Employee 關聯
