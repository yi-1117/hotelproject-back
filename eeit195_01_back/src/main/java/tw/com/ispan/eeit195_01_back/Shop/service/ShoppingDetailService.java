...
public class ShoppingDetailService {
    ...
    public Product findProductByShoppingDetailId(int shoppingDetailId) {
        ShoppingDetail detail = shoppingDetailRepository.findById(shoppingDetailId)
                .orElseThrow(() -> new EntityNotFoundException("No ShoppingDetail found for ID: " + shoppingDetailId));
        // 可能需要強制Hibernate加載
